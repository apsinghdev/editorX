      ...
      <main className="flex-1 container max-w-6xl mx-auto px-4 py-8">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A simple, elegant image editor with essential tools for quick
            adjustments.
          </p>
        </div>

        <div className="mx-auto max-w-4xl">
          {!imageState.image ? <ImageDropzone /> : <ImageEditor />}
        </div>
      </main>
      ...
      <footer className="py-6 border-t dark:border-gray-700">
        <div className="container max-w-6xl mx-auto px-4">
          <p className="text-sm text-center text-muted-foreground">
            Designed with simplicity and elegance in mind by Ajeet. &copy;{" "}
